...
uint8_t keycodes[16][8] PROGMEM = {{0x29, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x40}, //pb row 0, keycode matrix; edit this to change keymap. Fn slotted in as 0xFF
							       {0x41, 0x26, 0x37, 0x65, 0x0F, 0x03, 0x12, 0x40}, //pf row 0
							       {0x22, 0x21, 0x19, 0x05, 0x09, 0x0A, 0x15, 0x17}, //pb row 1
							       {0x23, 0x24, 0x10, 0x11, 0x0D, 0x0B, 0x18, 0x1C}, //pf row 1
							       {0x35, 0x1E, 0x1D, 0x03, 0x04, 0x29, 0x14, 0x2B}, //pb row 2
							       {0xE0, 0x3E, 0xE4, 0x03, 0x04, 0x03, 0x48, 0x06}, //pf row 2
							       {0x3B, 0x20, 0x06, 0x03, 0x07, 0x3D, 0x08, 0x3C}, //pb row 3
							       {0x3A, 0x1F, 0x1B, 0x03, 0x16, 0x03, 0x1A, 0x39}, //pf row 3
							       {0x4A, 0x4D, 0x03, 0x50, 0x58, 0x52, 0x57, 0x07}, //pb row 4
							       {0x03, 0x03, 0x03, 0x03, 0xE5, 0x03, 0x03, 0xE1}, //pf row 4
							       {0x49, 0x03, 0x54, 0x4F, 0x5A, 0x62, 0x60, 0x5D}, //pb row 5
							       {0x4B, 0x4E, 0x55, 0x56, 0x5B, 0x63, 0x61, 0x5E}, //pf row 5
