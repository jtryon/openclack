...
//Macro report
const USB_Descriptor_HIDReport_Datatype_t PROGMEM MacroReport[] =
{
		//Interface 0 HID Report Descriptor Keypad
		//Item Tag (Value) Raw Data
		HID_RI_USAGE_PAGE(8, 0x01), // Generic Desktop
		HID_RI_USAGE(8, 0x07), // Keypad
		HID_RI_COLLECTION(8, 0x01), // Application
	    	HID_RI_USAGE_PAGE(8, 0x07), // Key Codes
		    HID_RI_USAGE_MINIMUM(8, 0x00), // Undefined
		    HID_RI_USAGE_MAXIMUM(8, 0xE7), // Keyboard Right GUI
		    HID_RI_LOGICAL_MINIMUM(8, 0x00), // 0
		    HID_RI_LOGICAL_MAXIMUM(16, 0x00E7), // 231
		    HID_RI_REPORT_SIZE(8, 0x08),
		    HID_RI_REPORT_COUNT(8, 0x08),
			HID_RI_REPORT_ID(8, MACRO_REPORTID_KeyboardReport),
		    HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_ARRAY | HID_IOF_ABSOLUTE),
		HID_RI_END_COLLECTION(0),
		HID_RI_USAGE_PAGE(16, 0xFF00), // Vendor-Defined 1
//		HID_RI_USAGE_PAGE(8, 0xFF), // Vendor-Defined 1
//		0x06, 0x00, 0xFF,
		HID_RI_USAGE(8, 0x00),  // Undefined (0)
		HID_RI_COLLECTION(8, 0x01), // Application
			HID_RI_USAGE_PAGE(16, 0xFF00), //Vendor-Defined 1
//			HID_RI_USAGE_PAGE(8, 0xFF), // Vendor-Defined 1
			HID_RI_USAGE(8, 0x02), // Vendor defined 2
			HID_RI_REPORT_ID(8, MACRO_REPORTID_MacroReport),
			HID_RI_USAGE_PAGE(16, 0xFF00), // Vendor-Defined 1
//			HID_RI_USAGE_PAGE(8, 0xFF), // Vendor-Defined 1
			HID_RI_USAGE(8, 0x03), // Vendor defined 3
		    HID_RI_LOGICAL_MAXIMUM(16, 0x00FF), // 255
		    HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
			HID_RI_USAGE(8, 0x04), // Vendor defined 4
		    HID_RI_REPORT_COUNT(8, 0x03), // 3
		    HID_RI_FEATURE(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
			HID_RI_USAGE(8, 0x05), // Vendor defined 5
		    HID_RI_REPORT_COUNT(8, 0x12), // 18
		    HID_RI_OUTPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
			HID_RI_USAGE(8, 0x06), // Vendor defined 6
			HID_RI_REPORT_ID(8, MACRO_REPORTID_LCDReport),
		    HID_RI_REPORT_COUNT(16, 0x03DF), // 991
		    HID_RI_OUTPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
		HID_RI_END_COLLECTION(0),
};
...
//	.VendorID               = 0x03EB,
//	.ProductID              = 0x2042, //Keyboard ProductID from other Descriptor.c
//	.ReleaseNumber          = VERSION_BCD(00.01),

	.VendorID               = 0x046D,  // Logitech, Inc
	.ProductID              = 0xC222, //G15 rev1
	.ReleaseNumber          = VERSION_BCD(01.04),
	...
	.HID2_MacroHID =
		{
			...
			.TotalReportDescriptors = 1,
			.HIDReportType          = HID_DTYPE_Report,
			.HIDReportLength        = sizeof(MacroReport)
		},
	...
	.HID2_ReportOUTEndpoint =
		{
			...
			.EndpointAddress        = MACRO_OUT_EPADDR,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
